...
| A nested piece closes — a rework round, a sub-plan, a gate's own defect | The thing you descended into is finished | Restate the stack out loud: the original goal, the level you are back at, what that level still owes. Re-run any gate that ran before the work you just landed (Rule 25) |
