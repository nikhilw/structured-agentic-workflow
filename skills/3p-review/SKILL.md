...
A brief is executed literally by a model that cannot see what you meant, so a wrong line number does not produce a question; it produces an invented implementation. Run a plan's Passes 2 and 3 against your own brief, in this order:
